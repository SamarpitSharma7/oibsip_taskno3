...
public class Atm {
	...
	public static void login(String username, int pin) {
		if (username.contains("Dani") && pin == 6988) {
			list.add("Logged in");
			ask(6000);
		} else {
	...
	public static void quit(int balance, String qresponse) {
		if (qresponse.equals("yes") || qresponse.equals("Yes")) {
	...
	public static void main(String[] args) {
		System.out.println();
		// Use username as Given 'Dani'
		System.out.println("Use pin as '6988' for testing!");
